...
import { getUserActivity, getAdminStats } from "@/lib/admin-data"
...
export default function UserManagement() {
  ...
  const allUsers = useMemo(() => getUserActivity(), [])
  ...
  const filteredUsers = useMemo(() => {
    ...
    return users
  }, [allUsers, searchQuery, statusFilter, sortBy])
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatINR.format(Math.round(stats.totalBudgetAllTrips / stats.totalUsers))}
            </div>
        ...
        <CardContent>
          ...
          <div className="flex items-center justify-between mb-4">
            <p className="text-sm text-muted-foreground">
              Showing {formatNumber.format(filteredUsers.length)} of {formatNumber.format(allUsers.length)} users
            </p>
          </div>
